...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      { title: "Shop Products | JMB 2 Creations" },
      { name: "description", content: "Browse JMB 2 Creations product collections and available designs." },
    ],
  }),
  component: Shop,
});
    ...
    <StoreLayout>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="relative mx-auto max-w-xl">
          ...
          <Input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search product collections…" className="h-11 rounded-full pl-11" />
        </div>
