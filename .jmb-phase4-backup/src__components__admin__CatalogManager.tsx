import { Check, ImagePlus, Loader2, LogIn, LogOut, PackagePlus, Save, Trash2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button variant="soft" onClick={() => { clearAdminSession(); setSession(null); }}><LogOut /> Sign Out</Button>
      </div>
