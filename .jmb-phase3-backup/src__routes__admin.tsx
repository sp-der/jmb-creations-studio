...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Admin Dashboard | JMB 2 Creations" },
      {
        name: "description",
        content:
...
function AdminDashboard() {
  ...
  const sendQuote = () => {
    ...
    setRequest(updated);
    toast.success("Quote sent", { description: "$126 is now visible in the customer chat view." });
  };
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur">
        <div className="flex h-20 items-center gap-3 px-4 sm:px-6">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground">Manage catalog, orders and custom chats</p>
          </div>
      ...
      <div className="grid min-h-[calc(100dvh-5rem)] lg:grid-cols-[240px_minmax(0,1fr)]">
        <aside className="border-b border-border bg-card px-3 py-3 lg:border-b-0 lg:border-r lg:px-4 lg:py-6">
          ...
          <div className="mt-8 hidden rounded-[1.5rem] bg-secondary/40 p-4 lg:block">
            ...
            <p className="mt-3 text-sm font-bold">Quick links</p>
              ...
              <div className="flex flex-wrap items-end justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Manage the live catalog, orders, pickups and custom conversations from one workspace.
                  </p>
                </div>
                ...
                <section className="rounded-[1.75rem] border border-border bg-card p-5 shadow-soft sm:p-6">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">Shipping, pickup and custom orders</p>
                    </div>
